...
public class C01_NestedOgrenciMap {
    public static void main(String[] args) {
        ...
        // 101 nolu ogrencinin ismini yazdiralim

        System.out.println(ogrenciMap.get(101).get("Isim")); // Ali

        // 102 nolu ogrencinin sinif bilgisini yazdirin

        System.out.println(ogrenciMap.get(102).get("Sinif")); // 10

        // 103 nolu ogrencinin sube bil getirin

        System.out.println(ogrenciMap.get(103).get("Sube")); // K

        // 103 nolu ogrencinin sinifi 12 yapalim

        Set<Map.Entry<Integer, Map<String, String>>> ogrenciEntrySet = ogrenciMap.entrySet();

        for (Map.Entry<Integer, Map<String, String>> eachOgrenciEntry:ogrenciEntrySet) {
            // 101={Bolum=MF, Soyisim=Can, Sube=H, Sinif=11, Isim=Ali}
